...
export class GetInTouchComponent {
  ...
  contactInfo = [
    { 
      icon: 'email', 
      label: 'Email', 
      value: 'sasivardhanreddy33@gmail.com', // Replace with your actual email
      link: 'mailto:sasivardhanreddy33@gmail.com' 
    },
    { 
      icon: 'location_on', 
      label: 'Location', 
      value: 'Koblenz, Deutschland', // Replace with your actual location
       // Optional map link
    }
  ];
  ...
  connectLinks = [
    ...
    { 
      icon: 'merge', 
      label: 'GitHub', 
      url: 'https://github.com/SasiVardhanReddy3',
      // Unified gradient for all buttons
      bgColor: 'bg-gradient-to-r from-indigo-600 via-violet-600 to-fuchsia-600 hover:brightness-110 dark:from-cyan-500 dark:via-sky-500 dark:to-emerald-500'
    },
    { 
      icon: 'mail', 
      label: 'Email', 
      url: 'mailto:sasivardhanreddy33@gmail.com', 
      // Unified gradient for all buttons
      bgColor: 'bg-gradient-to-r from-indigo-600 via-violet-600 to-fuchsia-600 hover:brightness-110 dark:from-cyan-500 dark:via-sky-500 dark:to-emerald-500' 
    }
  ];
